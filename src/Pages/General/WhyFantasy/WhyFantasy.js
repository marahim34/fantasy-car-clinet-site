...
const WhyFantasy = () => {
    return (
        <div>
            <h1 className='text-4xl font-bold text-center mt-10'>Why Fantasy Car?</h1>
            <div className='grid md:grid-cols-3 justify-around p-10'>
                <div className="card w-96 shadow-xl image-full mb-10">
                    ...
                    <div className="card-body">
                        <div>
                            <div>
                                <h2 className="flex items-center text-2xl font-semibold"><GiTakeMyMoney className='text-6xl' /> Money Back Guarantee</h2>
                            </div>
                            <div>
                ...
                <div className="card w-96 shadow-xl image-full mb-10">
                    ...
                    <div className="card-body">
                        <div>
                            <div>
                                <h2 className="flex items-center text-2xl font-semibold"><AiOutlineSafetyCertificate className='text-6xl' /> Safe Purchase</h2>
                            </div>
                            <div>
                ...
                <div className="card w-96 shadow-xl image-full mb-10">
                    ...
                    <div className="card-body">
                        <div>
                            <div>
                                <h2 className="flex items-center text-2xl font-semibold"><GiShakingHands className='text-6xl' /> 6-Month warranty</h2>
                            </div>
                            <div>
